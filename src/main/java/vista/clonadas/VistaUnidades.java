...
public class VistaUnidades extends javax.swing.JFrame {
    ...
    private final String nameRecurso = "/unidades";
    Http peticion;
    ...
    private void initComponents() {
        ...
        jTableUnidadMedida = new javax.swing.JTable();
        ...
        jLabelTituloVentana.setText("LAB: UNIDADES");
        ...
        jTableUnidadMedida.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {},
                {},
                {},
        ...
        jScrollPane1.setViewportView(jTableUnidadMedida);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(jPanelContenedorTabla, javax.swing.GroupLayout.DEFAULT_SIZE, 476, Short.MAX_VALUE))
                .addContainerGap())
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jPanelInfo, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jPanelContenedorTabla, javax.swing.GroupLayout.DEFAULT_SIZE, 186, Short.MAX_VALUE))
        );
    ...
    public javax.swing.JTable jTableUnidadMedida;
    ...
    private void inicializarComponentes() {
        ...
        modelTabla.addColumn("UNIDAD DE MEDIDA");
        jTableUnidadMedida.setModel(modelTabla);
        peticion=new Http();
    ...
    private Object[] construirTabla(String json) {
        ...
        for (int i = 0; i < areasJSON.length(); i++) {
            ...
            areas[1] = areasJSON.getJSONObject(i).get("unidadDeMedida").toString();
    ...
    private void Grabar() {
        if (jTextFieldNombre.getText().isBlank()) {
            ...
            data = new HashMap<>();
            data.put("unidadDeMedida", this.jTextFieldNombre.getText());
    ...
    private void Eliminar() {
        int identificador = this.jTableUnidadMedida.getSelectedRow();
        if (identificador == -1) {
            JOptionPane.showMessageDialog(null, "Seleccione una fila");
        } else {
            String idArea = (String) this.jTableUnidadMedida.getValueAt(identificador, 0);
